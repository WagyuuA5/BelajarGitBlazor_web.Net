...
// Konfigurasi Cookie Authentication (Dari Choqie)
...
builder.Services.AddScoped<AuthService>(); // (Gabungan Wahyu/Choqie)

// Custom Auth State Provider dari Wahyu, agar UI sinkron
...
// === Auto-migrate database saat startup (Dari Choqie) ===
